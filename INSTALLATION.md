...
$ helm install ./api/helm --name contactcatalogus --kubeconfig="api/helm/kubeconfig.yaml"

Or update if you want to update an existing one
$ helm upgrade contactcatalogus  ./api/helm --kubeconfig="api/helm/kubeconfig.yaml" 

Or del if you want to delete an existing  one
$ helm del contactcatalogus  --purge --kubeconfig="api/helm/kubeconfig.yaml" 
